        ...
        <div className="flex flex-col lg:flex-row  justify-between items-start gap-8 text-center lg:text-left">
          ...
          <div className="w-full lg:w-1/3 mb-4 lg:mb-0">
            <Link to="/" className="text-xl font-semibold">
              <span className="font-bold text-[#262626]">MAHA'S STORE</span>
            </Link>
            <p className="text-slate-500 mt-3 leading-relaxed">
              Discover your unique style with Maha's Store – where fashion elevates your wardrobe with our latest collections.
            </p>
          </div>
          ...
          <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-4 lg:mt-0">
            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              <Footer.LinkGroup col>
                <Footer.Link> Mahzaib</Footer.Link>
                <Footer.Link>mahzaib@example.com</Footer.Link>
              </Footer.LinkGroup>
            </div>
