        ...
        <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
          <div>
            ...
            <div className="flex flex-col justify-center mt-2">
              ...
              <p className="text-sm tracking-wide text-gray-800">
                "MAHA'S Store products are exceptional! Quality is unmatched, and
          ...
          <div>
            ...
            <div className="flex flex-col justify-center mt-2">
              ...
              <p className="text-sm tracking-wide text-gray-800">
                "Amazing variety and top-notch products! MAHA'S Store always
          ...
          <div>
            ...
            <div className="flex flex-col justify-center mt-2">
              ...
              <p className="text-sm tracking-wide text-gray-800">
                "Shopping with MAHA'S Store has been a fantastic experience. The
          ...
          <div>
            ...
            <div className="flex flex-col justify-center mt-2">
              ...
              <p className="text-sm tracking-wide text-gray-800">
                "MAHA'S Store consistently delivers on quality and style. Their
